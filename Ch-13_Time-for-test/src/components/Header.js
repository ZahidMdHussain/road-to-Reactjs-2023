        ...
        <div className='flex items-center justify-between py-4 px-6 text-slate-500 text-lg shadow-md bg-slate-100 font-sans font-medium'>
            ...
            <div className="flex items-center">
                <ul className='flex list-none'>
                    ...
                    <li className='px-4 '>
                    <Link className='hover:text-pink-600 outline-none duration-300 hover:underline hover:underline-offset-4 hover:ease-in-out focus:outline-none' to="/cart">Cart 
                    <span data-testid="cart" className="bg-[#60b246] px-[4] text-xs font-bold text-white align-top">{cartItems.length}</span></Link>
                    </li>
                </ul>
            </div>
            <div>
